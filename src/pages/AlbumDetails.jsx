...
export function AlbumDetails() {
  ...
  async function getAlbum(albumId) {
    ...
    albumDet.tracks.items.forEach(
      (track) => (track.imgUrl = albumDet.images[0].url)
    )
    ...
    <React.Fragment>
      <div className='album-details-container'>
        <section style={gradientStyle}>
          ...
          <div className='album-header'>
            ...
            <div className='album-info'>
              <h3>
                {albumDetails.album_type.replace(/(?:^|\s|[-"'([{])+\S/g, (c) =>
                  c.toUpperCase()
                )}
              </h3>
              ...
              <p className='album-creator'>
                ...
                {albumDetails.tracks.items.length}{' '}
                {albumDetails.tracks.items.length > 1 ? 'songs' : 'song'}
                {albumDetails.tracks.items.length
        ...
        <div className='album-controls'>
          <button
            onClick={() => onClickPlay(albumDetails.tracks.items[0])}
          ...
          <div
            className={`header-add-button ${
              albumDetails.likedByUsers?.find(
